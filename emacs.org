  ...
  (unless (eq system-type 'darwin)
    ...
    (use-package doom-modeline
      ...
      (setq doom-modeline-height 1
            ...
            doom-modeline-continuous-word-count-modes '(markdown-mode org-mode LaTeX-mode)
...
#+BEGIN_SRC emacs-lisp :noweb-ref ess
  ...
  (use-package ess-smart-underscore :after ess-site :disabled)
...
#+BEGIN_SRC emacs-lisp :noweb-ref ess
  (use-package polymode 
    :config
    (setq-default polymode-lsp-integration nil) ; otherwise polymode is unusable
...
#+BEGIN_SRC emacs-lisp :noweb-ref org
  ...
  (use-package org-wc
    :straight (:host github :repo "tesujimath/org-wc"))
#+END_SRC
...
Experimental support for [[https://typst.app][Typst]]
...
#+BEGIN_SRC emacs-lisp :noweb-ref editing
  (use-package helm-bibtex
    :straight (:host github :repo "tmalsburg/helm-bibtex")
    :after oc-csl
    :bind
...
#+begin_src emacs-lisp :noweb-ref editing
  (use-package binder
    :config
    (evil-set-initial-state 'binder-sidebar-mode 'emacs))
#+end_src
** Undo-tree
...
#+begin_src emacs-lisp :noweb-ref utils
  ...
  (cl-loop for command in '(mu4e mu4e-alert-view-unread-mails) do
  	 (advice-add command :before
  		     (lambda (&rest r)
  		       (persp-switch "main"))
  		     '((name . "switch-to-main-perspective"))))
#+end_src
** COMMENT Treemacs
