...
#+BEGIN_SRC emacs-lisp :noweb-ref appearance
  ;; (setq default-frame-alist '((font . "Iosevka SS05-15")))
  ...
  (custom-set-faces
   '(default ((t (:family "Iosevka SS05" :weight light :height 150))))
...
#+begin_src emacs-lisp :noweb-ref editing
  (use-package palimpsest-mode
    ...
    :hook (text-mode-hook . palimpsest-mode)
    :custom
...
#+begin_src emacs-lisp :nowe-ref editing
