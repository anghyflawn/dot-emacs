...
*** R
    ...
    #+BEGIN_SRC emacs-lisp :tangle no
      ...
      ;; Minor tweak to respect TeX-master if set
        ...
        (let* ((rnw-buf (current-buffer)))
          ...
          (save-excursion
            ...
            (let* ((sprocess (ess-get-process ess-current-process-name))
                   ...
                   (rnw-file (if (and TeX-master (stringp TeX-master))
                                 TeX-master
                               (buffer-file-name)))
...
#+BEGIN_SRC emacs-lisp :tangle no
  (use-package helm-bibtex
    ...
    (setq bibtex-completion-bibliography '("~/Library/texmf/bibtex/bib/biblio.bib")
          ...
          helm-bibtex-browser-function 'eww-browse-with-external-browser ; this doesn't work
          helm-bibtex-cite-prompt-for-optional-arguments nil
          helm-bibtex-completion-additional-search-fields '(subtitle booksubtitle tags)
