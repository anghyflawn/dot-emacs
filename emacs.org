...
#+begin_src emacs-lisp :tangle yes :noweb no-expert :exports code
...
#+NAME: utils
#+BEGIN_SRC emacs-lisp :tangle yes :noweb no-export :export code
...
#+BEGIN_SRC emacs-lisp :tangle yes :noweb no-export :exports code
  (use-package subed
    ...
    (add-hook 'subed-mode-hook 'typopunct-mode)
