...
#+BEGIN_SRC emacs-lisp :noweb-ref appearance
  ...
  (set-face-attribute 'fixed-pitch nil :family "Iosevka SS09" :weight (if (eq system-type 'darwin) 'medium 'light) :height 170)
...
#+BEGIN_SRC emacs-lisp :noweb-ref org
    (use-package org-ref
      :after (org oc)
      :config
      (setq org-ref-default-bibliography `(,private/bibliography-file ,private/russian-bibliography-file)
    ...
    (use-package oc-csl
      ...
      (setq org-cite-csl-locales-dir (expand-file-name "etc/csl/" user-emacs-directory)
            ...
            org-cite-global-bibliography `(,private/bibliography-file ,private/russian-bibliography-file)))
#+END_SRC
