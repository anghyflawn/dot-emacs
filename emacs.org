...
#+BEGIN_SRC emacs-lisp :tangle no
  (use-package helm-bibtex
    ...
    (setq bibtex-completion-bibliography '("~/Dropbox/biblio.bib")
	  ...
	  '((t . "${author:36} ${title:*} ${date:4} ${=has-pdf=:1}${=has-note=:1} ${=type=:7}")))
...
#+BEGIN_SRC emacs-lisp :tangle no
  (use-package mu4e
    ...
    (setq cy_GB.utf8-message-citation-line-format "%A, %b %d %Y, ysgrifennodd %N:\n")
    (setq gd_GB.utf8-message-citation-line-format "Aig %A, %b %d %Y, sgrìobh %N:\n")
    (setq ga_IE.utf8-message-citation-line-format "Ag %A, %b %d %Y, scríobh %N:\n")
