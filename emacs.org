...
#+BEGIN_SRC emacs-lisp :noweb-ref appearance
  ...
  (set-face-attribute 'variable-pitch nil :family "Literata" :height 160 :weight 'medium)
  ;; (custom-set-faces
...
#+BEGIN_SRC emacs-lisp :noweb-ref org
  ...
  (defun my-clock-files ()
    (append org-agenda-files private/org-project-files))
...
#+BEGIN_SRC emacs-lisp :noweb-ref editing
  (use-package helm-bibtex
    ...
    (helm-delete-action-from-source "Insert formatted citation(s)" helm-source-bibtex)
